...
class Colour
{
   ...
   public function new(red:Int, green:Int, blue:Int)
	...
	private function get_red():Int { return (mRGB>>16) & 0xff; }
	private function set_red(inRed:Int):Int
		{ mRGB = (mRGB & 0x00ffff) | (inRed & 0xff); return inRed; }

	private function get_green():Int { return (mRGB>>8) & 0xff; }
	private function set_green(inGreen:Int):Int
		{ mRGB = (mRGB & 0xff00ff) | (inGreen & 0xff); return inGreen; }

	private function get_blue():Int { return (mRGB>>16) & 0xff; }
	private function set_blue(inBlue:Int):Int
		{ mRGB = (mRGB & 0xffff00) | (inBlue & 0xff); return inBlue; }

	private function get_combined() { return mRGB; }
	private function set_combined(inVal:Int) { mRGB = inVal & 0xffffff; return mRGB; }
